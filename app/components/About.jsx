...
export default function About() {
  const skills = [
    ...
    { icon: <Database className="w-8 h-8 text-purple-500" />, title: "Version Control", description: "Git, GitHub" },
    { icon: <Zap className="w-8 h-8 text-yellow-500" />, title: "Performance", description: "Optimization, Caching" },
    { icon: <Server className="w-8 h-8 text-yellow-500" />, title: "BaaS", description: "Appwrite" },
  ]
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              ...
              a strong foundation in React, Next.js. I create seamless front-end solutions
